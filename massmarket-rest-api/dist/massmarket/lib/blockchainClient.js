...
class BlockchainClient {
    constructor(storeId = (0, viem_1.bytesToHex)((0, utils_1.eventId)())) {
        this.storeId = storeId;
    }
    createStore(wallet) {
        return __awaiter(this, void 0, void 0, function* () {
            const hash = yield wallet.writeContract({
    ...
    createInviteSecret(wallet) {
        return __awaiter(this, void 0, void 0, function* () {
            const privateKey = (0, viem_1.bytesToHex)((0, utils_1.randomBytes)(32));
