...
const Sort = ({ isOpen, close, setCheck, sortOption, }) => {
    ...
    const renderOptions = () => {
        return options.map((o) => {
            ...
            return (<div key={o}>
          <input type="radio" id={o} value={o} checked={selected == o} onChange={(e) => handleChange(e)}/>
    ...
    return (<section>
      <HalfModal isOpen={isOpen} onClose={close}>
        ...
        <div className="mt-6">
          <Button color={"bg-gradient-to-r from-button-gradient-start to-button-gradient-end"} onClick={() => {
            setCheck(selected);
            close();
        }}>
            Apply
