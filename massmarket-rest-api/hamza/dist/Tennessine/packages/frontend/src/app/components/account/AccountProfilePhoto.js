...
const AccountProfilePhoto = ({ closePhotoUpload, setProfilePhoto, }) => {
    ...
    return (<section className="pt-under-nav h-screen">
      {showSuccessMsg ? (<SuccessMessage show={!!showSuccessMsg} onClose={closeSuccessMessage}/>) : (<ModalHeader headerText="Edit Profile Photo" goBack={closePhotoUpload}/>)}
...
//# sourceMappingURL=AccountProfilePhoto.js.map