...
const StoreProfile = ({ close }) => {
    const [storeName, setStoreName] = useState("ethDubai");
    const [storeURL, setStoreURL] = useState("ethdubai.mass.market");
    ...
    className="border-2 border-solid mt-1 p-2 rounded" id="fname" name="fname" value={storeName}/>
                </form>
              </section>
              {/* <p>Store Name</p> */}
            </div>
            <div>
              <section>
                <form className="flex flex-col" onSubmit={(e) => e.preventDefault()}>
                  ...
                  <input className="border-2 border-solid mt-1 p-2 rounded" id="fname" name="fname" value={storeURL}/>
                </form>
              </section>
            </div>
          </section>
