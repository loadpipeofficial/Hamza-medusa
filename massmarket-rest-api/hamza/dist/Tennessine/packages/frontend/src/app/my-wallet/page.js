...
const MyWallet = () => {
    ...
    return (<main className="absolute bg-white left-0 right-0 bottom-0 top-0">
      <div className="w-full border border-gray-200 p-4 text-base flex flex-col justify-between">
        <div className="flex justify-between">
          <div className="flex gap-1">
            <Image src="/assets/meta-mask.png" width={24} height={24} alt="meta-mask" unoptimized={true} // TODO: pre-scale images
    />
      ...
      <section className="flex flex-col mt-6 gap-4 mx-4">
        <button className="flex justify-center border-2 rounded border-gray-900 p-4">
          <div className="flex gap-2" onClick={copyToClipboard}>
            <Image src="/assets/copy-icon.svg" width={24} height={24} alt="eclipse-avatar"/>
            <p>copy address</p>
          </div>
        </button>
        <button onClick={logout} className="border-2 rounded p-4 border-gray-900">
          logout
        </button>
      </section>
    </main>);
