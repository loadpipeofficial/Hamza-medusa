...
const AccountSettings = () => {
    ...
    const [profilePhoto, setProfilePhoto] = useState("/assets/example-avatar.svg");
    ...
    if (openNameEdit) {
        return (<EditName closeEditName={() => setOpenNameEdit(false)} setFirstName={setFirstName} firstName={firstName}/>);
    }
    else if (openPhotoUpload) {
        return (<AccountProfilePhoto setProfilePhoto={setProfilePhoto} closePhotoUpload={() => setOpenPhotoUpload(false)}/>);
    }
    return (<main className="mx-4 pt-under-nav">
      ...
      <section className="mb-24">
        <section>
          ...
          <section className="border-b border-gray-200 py-6">
            ...
            <div className="flex justify-between mt-2" onClick={() => setOpenNameEdit(true)}>
              <p className="text-gray-700">{firstName}</p>
              <Image src="/assets/forward-arrow.svg" width={24} height={24} alt="forward-arrow"/>
            </div>
          </section>
          <section className="border-b border-gray-200 py-6">
            <p className="text-xs text-gray-500">Profile Photo</p>
            <div className="flex justify-between mt-2" onClick={() => setOpenPhotoUpload(true)}>
              <Image src={profilePhoto} width={24} height={24} alt="profile-avatar"/>
              <Image src="/assets/forward-arrow.svg" width={24} height={24} alt="forward-arrow"/>
            </div>
          </section>
          <section className="border-b border-gray-200 py-6">
          ...
          <section className="border-b border-gray-200 py-6">
            ...
            <div className="flex justify-between mt-2">
              ...
              <button onClick={copyToClipboard}>
                <Image src="/assets/copy-icon.svg" width={24} height={24} alt="copy-icon"/>
              </button>
            </div>
          </section>
        </section>
