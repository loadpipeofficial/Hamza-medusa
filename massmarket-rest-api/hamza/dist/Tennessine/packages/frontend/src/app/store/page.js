...
function Page() {
    const [openStoreProfile, setOpenStoreProfile] = useState(false);
    const [openPermissions, setOpenPermissions] = useState(false);
    const [openRelays, setOpenRelays] = useState(false);
    if (openStoreProfile) {
    ...
    return (<main className="pt-under-nav">
      <section>
      ...
      <section className="m-4 flex flex-col gap-10">
        <section className="mt-4">
          ...
          <div className="flex justify-between mt-4 border rounded p-4" onClick={() => setOpenStoreProfile(true)}>
            <div>
              <p>Store profile</p>
            ...
            <Image src="/assets/forward-arrow.svg" width={24} height={24} alt="eclipse-avatar"/>
          </div>
          <div className="flex justify-between border rounded p-4" onClick={() => setOpenPermissions(true)}>
            <div>
              <p>Permissions</p>
        ...
        <section>
          ...
          <div onClick={() => setOpenRelays(true)} className="flex justify-between mt-4 border rounded p-4">
            <div>
              <p>Relays</p>
