...
function Page() {
    const [totalEarnings, setTotalEarnings] = useState(255.4);
    ...
    return (<main className="bg-gray-100 p-4 pt-under-nav h-screen">
      <section className="pt-4">
        ...
        <section className="flex justify-evenly my-6">
          <div className="py-4 px-6 bg-gray-200 rounded">
            ...
            <div className="flex gap-2 my-2">
              <Image src="/assets/dollar-avatar.svg" width={24} height={24} alt="dollar-avatar" className="h-6"/>
              <p>{totalEarnings}</p>
            </div>
            <div className="flex">
              <Image src="/assets/green-up-arrow.svg" width={16} height={16} alt="green-up-arrow" className="h-6"/>
        ...
        <section className="mt-8">
          ...
          <div className="border-b-2 text-gray-500">
            ...
            <div className="flex gap-4 mb-4">
              <Image src="/assets/arb-avatar.svg" width={24} height={24} alt="eth-avatar" className="h-6"/>
              <p>ARB</p>
              <p className="ml-auto">TBD</p>
            </div>
          </div>
