    ...
    return (<main className="pt-under-nav">
      ...
      <section className="mx-4" id="provisioned">
        <div className="mb-4 flex flex-row gap-2">
          ...
          <Image src="/assets/information-icon.svg" width={18} height={18} alt="information-icon"/>
        </div>
        ...
        <section data-testid="available" className="mt-8">
          ...
          <div className="border rounded px-4 pb-4">
            {relays.map((r) => {
            return r.provisioned ? (<RelayBlock key={r.name} item={r} addable={true}/>) : null;
        })}
          </div>
        </section>
      </section>
...
//# sourceMappingURL=RelaysView.js.map