...
test("push and load", async () => {
    ...
    val4.fill(3);
    await mmr.push(val4);
    root = keccak_256(MMR.xorUint8Arrays(keccak_256(MMR.xorUint8Arrays(keccak_256(val1), keccak_256(val2))), keccak_256(MMR.xorUint8Arrays(keccak_256(val3), keccak_256(val4)))));
    expect(isEqualArray(mmr._root, root)).toBe(true);
