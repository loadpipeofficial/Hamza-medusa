...
export const market = ($root.market = (() => {
    ...
    market.mass = (function () {
            ...
            StoreManifest.verify = function verify(message) {
                ...
                if (
                    ...
                    if (
                        !(
                            (message.eventId &&
                                typeof message.eventId.length === 'number') ||
            ...
            UpdateManifest.verify = function verify(message) {
                ...
                if (message.tagId != null && message.hasOwnProperty('tagId')) {
                    ...
                    if (
                        !(
                            (message.tagId &&
                                typeof message.tagId.length === 'number') ||
            ...
            UpdateItem.verify = function verify(message) {
                ...
                if (message.itemId != null && message.hasOwnProperty('itemId'))
                    if (
                        !(
                            (message.itemId &&
                                typeof message.itemId.length === 'number') ||
            ...
            ChangeStock.verify = function verify(message) {
                ...
                if (message.cartId != null && message.hasOwnProperty('cartId'))
                    if (
                        !(
                            (message.cartId &&
                                typeof message.cartId.length === 'number') ||
                ...
                if (message.txHash != null && message.hasOwnProperty('txHash'))
                    if (
                        !(
                            (message.txHash &&
                                typeof message.txHash.length === 'number') ||
        ...
        mass.Event = (function () {
            ...
            Event.verify = function verify(message) {
                ...
                if (
                    ...
                    properties.union = 1;
                    {
                        let error = $root.market.mass.CreateItem.verify(
                            message.createItem
                        );
                ...
                if (
                    ...
                    properties.union = 1;
                    {
                        let error = $root.market.mass.UpdateItem.verify(
                            message.updateItem
                        );
                ...
                if (
                    ...
                    properties.union = 1;
                    {
                        let error = $root.market.mass.CreateTag.verify(
                            message.createTag
                        );
                ...
                if (
                    ...
                    properties.union = 1;
                    {
                        let error = $root.market.mass.AddToTag.verify(
                            message.addToTag
                        );
                ...
                if (
                    ...
                    properties.union = 1;
                    {
                        let error = $root.market.mass.RenameTag.verify(
                            message.renameTag
                        );
                ...
                if (
                    ...
                    properties.union = 1;
                    {
                        let error = $root.market.mass.DeleteTag.verify(
                            message.deleteTag
                        );
                ...
                if (
                    ...
                    properties.union = 1;
                    {
                        let error = $root.market.mass.CreateCart.verify(
                            message.createCart
                        );
                ...
                if (
                    ...
                    properties.union = 1;
                    {
                        let error = $root.market.mass.ChangeCart.verify(
                            message.changeCart
                        );
                ...
                if (
                    ...
                    properties.union = 1;
                    {
                        let error = $root.market.mass.NewKeyCard.verify(
                            message.newKeyCard
                        );
        ...
        mass.AuthenticateRequest = (function () {
             ...
             * @throws {$protobuf.util.ProtocolError} If required fields are missing
             */
            AuthenticateRequest.decodeDelimited = function decodeDelimited(
                reader
            ) {
                if (!(reader instanceof $Reader)) reader = new $Reader(reader);
                return this.decode(reader, reader.uint32());
        ...
        mass.AuthenticateResponse = (function () {
             ...
             * @throws {$protobuf.util.ProtocolError} If required fields are missing
             */
            AuthenticateResponse.decodeDelimited = function decodeDelimited(
                reader
            ) {
                if (!(reader instanceof $Reader)) reader = new $Reader(reader);
                return this.decode(reader, reader.uint32());
        ...
        mass.CommitCartRequest = (function () {
             ...
             * @throws {$protobuf.util.ProtocolError} If required fields are missing
             */
            CommitCartRequest.decodeDelimited = function decodeDelimited(
                reader
            ) {
                if (!(reader instanceof $Reader)) reader = new $Reader(reader);
                return this.decode(reader, reader.uint32());
        ...
        mass.CommitCartResponse = (function () {
             ...
             * @throws {$protobuf.util.ProtocolError} If required fields are missing
             */
            CommitCartResponse.decodeDelimited = function decodeDelimited(
                reader
            ) {
                if (!(reader instanceof $Reader)) reader = new $Reader(reader);
                return this.decode(reader, reader.uint32());
                    ...
                    if (
                        !(
                            (message.cartFinalizedId &&
                                typeof message.cartFinalizedId.length ===
                                    'number') ||
        ...
        mass.GetBlobUploadURLResponse = (function () {
            ...
            GetBlobUploadURLResponse.fromObject = function fromObject(object) {
                if (
                    object instanceof $root.market.mass.GetBlobUploadURLResponse
                )
                    return object;
        ...
        mass.EventWriteRequest = (function () {
             ...
             * @throws {$protobuf.util.ProtocolError} If required fields are missing
             */
            EventWriteRequest.decodeDelimited = function decodeDelimited(
                reader
            ) {
                if (!(reader instanceof $Reader)) reader = new $Reader(reader);
                return this.decode(reader, reader.uint32());
        ...
        mass.EventWriteResponse = (function () {
             ...
             * @throws {$protobuf.util.ProtocolError} If required fields are missing
             */
            EventWriteResponse.decodeDelimited = function decodeDelimited(
                reader
            ) {
                if (!(reader instanceof $Reader)) reader = new $Reader(reader);
                return this.decode(reader, reader.uint32());
        ...
        mass.SyncStatusRequest = (function () {
             ...
             * @throws {$protobuf.util.ProtocolError} If required fields are missing
             */
            SyncStatusRequest.decodeDelimited = function decodeDelimited(
                reader
            ) {
                if (!(reader instanceof $Reader)) reader = new $Reader(reader);
                return this.decode(reader, reader.uint32());
        ...
        mass.SyncStatusResponse = (function () {
             ...
             * @throws {$protobuf.util.ProtocolError} If required fields are missing
             */
            SyncStatusResponse.decodeDelimited = function decodeDelimited(
                reader
            ) {
                if (!(reader instanceof $Reader)) reader = new $Reader(reader);
                return this.decode(reader, reader.uint32());
        ...
        mass.EventPushRequest = (function () {
            ...
            EventPushRequest.verify = function verify(message) {
                ...
                if (
                    ...
                    for (let i = 0; i < message.events.length; ++i) {
                        let error = $root.market.mass.Event.verify(
                            message.events[i]
                        );
        ...
        mass.EventPushResponse = (function () {
             ...
             * @throws {$protobuf.util.ProtocolError} If required fields are missing
             */
            EventPushResponse.decodeDelimited = function decodeDelimited(
                reader
            ) {
                if (!(reader instanceof $Reader)) reader = new $Reader(reader);
                return this.decode(reader, reader.uint32());
